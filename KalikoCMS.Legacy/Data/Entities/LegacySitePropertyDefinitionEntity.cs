...
namespace KalikoCMS.Legacy.Data.Entities {
    ...
    public class LegacySitePropertyDefinitionEntity {
        ...
        public virtual ICollection<LegacySitePropertyEntity> SiteProperties { get; set; }

        public LegacySitePropertyDefinitionEntity() {
